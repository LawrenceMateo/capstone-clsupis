                    ...
                    <div class="modal-body">
                        <form class="form-container" onsubmit="return addAgency()">
                            <div class="form-group">
                                <input id="agency-name" class="form-control" type="text" name="agency_name" placeholder="Agency Name">
                            </div>
                            <div class="form-group">
                                <input id="agency-address" class="form-control" type="text" name="agency_address" placeholder="Agency Address">
                            </div>
